...
import { SingeTaskScheduler } from '../utils/single-task-scheduler';
import { getTaskDir } from '../utils/simple-ffmpeg-task';
...
export const ipcHandler = compose([router.routes()]);
